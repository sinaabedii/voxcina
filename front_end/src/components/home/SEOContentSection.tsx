      ...
      <div className="max-w-4xl mx-auto bg-white/80 dark:bg-voxcina-blue/10 backdrop-blur-sm rounded-2xl p-6 md:p-10 shadow-soft border border-voxcina-cream/30 dark:border-voxcina-blue/20">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed text-sm md:text-base text-right">
          <p>
            ...
            به شما کمک می‌کند تا با اعتماد به نفس بیشتری ظاهر شوید. ما در <strong>وکسینا</strong> معتقدیم که هر فردی 
            سبک منحصر به فرد خود را دارد و وظیفه ما ارائه گزینه‌های متنوع برای تحقق این سبک است.
          </p>
          
          <p>
            در <strong>فروشگاه اینترنتی وکسینا</strong>، شما می‌توانید از میان صدها طرح و مدل <strong>لباس و پوشاک</strong>، 
          ...
          <p>
            تیم طراحی <strong>وکسینا</strong> با دنبال کردن آخرین ترندهای مد جهانی، محصولاتی را انتخاب می‌کند که 
            هم با سلیقه ایرانی همخوانی داشته باشد و هم استانداردهای بین‌المللی <strong>پوشاک</strong> را رعایت کند. 
            ما به کیفیت پارچه، دوخت و طراحی محصولات اهمیت ویژه‌ای می‌دهیم.
          </p>
          
          <p>
            با خرید از <strong>فروشگاه اینترنتی لباس وکسینا</strong>، علاوه بر دسترسی به بهترین محصولات <strong>پوشاک</strong>، 
