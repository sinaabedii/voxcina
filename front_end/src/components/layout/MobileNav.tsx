    ...
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center justify-between p-3 sm:p-4 border-b border-voxcina-cream/30 dark:border-voxcina-blue/30">
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center rounded-full text-voxcina-blue/70 hover:text-voxcina-blue dark:text-voxcina-cream/70 dark:hover:text-voxcina-cream hover:bg-voxcina-cream/30 dark:hover:bg-voxcina-blue/30 transition-all duration-300"
          >
          ...
          <nav className="space-y-1.5 sm:space-y-2">
            {navItems.map((item) => (
              <div key={item.href} className="rounded-lg sm:rounded-xl overflow-hidden">
                <div
                  className={`flex items-center justify-between p-3 sm:p-3.5 rounded-lg sm:rounded-xl transition-all duration-300 ${
                    pathname === item.href
                ...
                >
                  ...
                  {item.children && (
                    <button
                      ...
                      className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full hover:bg-voxcina-blue/10 dark:hover:bg-voxcina-blue/30"
                        ...
                        {item.children.map((child) => (
                          ...
                          >
                            <Link
                              ...
                              onClick={onClose}
                              className={cn(
                                "block py-2 sm:py-2.5 px-2.5 sm:px-3 rounded-md sm:rounded-lg text-sm transition-all duration-300",
                                pathname === child.href
          ...
          {isAuthenticated ? (
            <div>
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg sm:rounded-xl text-center text-sm font-medium bg-voxcina-blue dark:bg-voxcina-cream/90 text-white dark:text-voxcina-blue hover:bg-voxcina-darkBlue dark:hover:bg-voxcina-cream transition-all duration-300 shadow-sm hover:shadow-md"
              >
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              <div>
                <Link
                  href="/sign-in"
                  className="block py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg sm:rounded-xl text-center text-sm font-medium border border-voxcina-blue dark:border-voxcina-cream/30 text-voxcina-blue dark:text-voxcina-cream bg-transparent hover:bg-voxcina-cream/30 dark:hover:bg-voxcina-blue/30 transition-all duration-300 shadow-sm hover:shadow-md"
                  onClick={onClose}
                >
                  ورود
                </Link>
              ...
              <div>
                <Link
                  href="/sign-up"
                  className="block py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg sm:rounded-xl text-center text-sm font-medium bg-voxcina-blue dark:bg-voxcina-cream/90 text-white dark:text-voxcina-blue hover:bg-voxcina-darkBlue dark:hover:bg-voxcina-cream transition-all duration-300 shadow-sm hover:shadow-md"
                  onClick={onClose}
                >
                  ثبت نام
                </Link>
