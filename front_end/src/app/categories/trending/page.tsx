...
export default function TrendingPage() {
  ...
  return (
    <div className="min-h-screen pb-16 overflow-x-hidden bg-voxcina-cream dark:bg-voxcina-darkBlue/90">
      <section
        ref={heroRef}
        className="relative h-[60vh] md:h-[75vh] overflow-hidden"
      >
        <motion.div
          className="absolute inset-0 bg-gradient-to-r from-voxcina-darkBlue via-voxcina-blue to-primary-600"
          style={{ y: heroY }}
        />
        <div className="absolute inset-0 bg-[url('/pattern.svg')] opacity-10 mix-blend-overlay" />

        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-primary-400/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-primary-600/20 rounded-full blur-3xl"></div>
        </div>
        ...
        >
          <div className="max-w-3xl px-6">
            ...
            >
              <span className="inline-block py-1.5 px-4 rounded-full bg-white/10 backdrop-blur-sm text-secondary-200 text-sm border border-white/20 shadow-soft">
                #FashionTrends2025
              </span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-white relative"
            >
              <span className="relative z-10">ترندهای مد</span>{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary-100 to-secondary-200 relative">
                <span className="relative z-10">۱۴۰۴</span>
                <span className="absolute bottom-1.5 left-0 w-full h-3 bg-secondary-200/20 rounded-full -z-0 opacity-40"></span>
              </span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg md:text-xl mb-10 text-secondary-100"
            >
            ...
            >
              <motion.a
                href="#trends"
                className="bg-white text-voxcina-blue hover:bg-secondary-100 px-8 py-4 rounded-xl font-medium transition-all duration-300 hover:shadow-medium shadow-soft inline-block"
        ...
        >
          <span className="text-secondary-200 mb-2 text-sm">اسکرول کنید</span>
          <span className="w-6 h-10 border-2 border-secondary-200/30 rounded-full flex justify-center pt-1">
            <motion.span
              className="w-1.5 h-1.5 bg-secondary-200 rounded-full"
              animate={{ y: [0, 12, 0] }}
              transition={{
                repeat: Infinity,
                duration: 1.5,
      ...
      <section className="container mx-auto py-20 px-6 relative">
        ...
        >
          <motion.h2
            className="text-3xl md:text-4xl font-bold mb-6 text-voxcina-blue dark:text-secondary-200 relative inline-block"
            variants={fadeIn}
          >
          ...
          <motion.p
            className="text-voxcina-blue/80 dark:text-secondary-300 mb-10"
            variants={fadeIn}
          >
          ...
          <motion.div
            className="flex flex-wrap justify-center gap-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-voxcina-blue/20 scrollbar-track-secondary-100 dark:scrollbar-thumb-voxcina-blue/30 dark:scrollbar-track-voxcina-darkBlue/20"
            variants={staggerContainer}
          >
            {uniqueCategories.map((category, index) => (
              <motion.button
                key={category}
                className={`px-5 py-2.5 rounded-xl transition-all shadow-soft ${
                  activeCategory === category
                    ? "bg-voxcina-blue text-white dark:bg-voxcina-blue/80"
                    : "bg-secondary-100 dark:bg-voxcina-blue/10 text-voxcina-blue dark:text-secondary-200 hover:bg-secondary-200/70 dark:hover:bg-voxcina-blue/20"
                }`}
      ...
      <section id="trends" className="container mx-auto py-10 px-6 relative">
        <div className="absolute inset-0 z-0 overflow-hidden">
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-voxcina-blue/5 dark:bg-voxcina-blue/10 rounded-full blur-3xl"></div>
        </div>
        {isLoading ? (
          <div className="h-96 flex items-center justify-center relative z-10">
            <div className="relative w-20 h-20">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-voxcina-blue/40 dark:text-secondary-200/40 text-lg font-medium">
                Voxcina
              </div>
            </div>
          </div>
                ...
                <div className="p-6">
                  <div className="flex items-center mb-4">
                    <div className="flex -space-x-3 space-x-reverse ml-4">
                      {[...Array(3)].map((_, i) => (
                        <div
                          key={i}
                          className="w-8 h-8 rounded-full border-2 border-white dark:border-voxcina-blue/10 bg-secondary-100 dark:bg-voxcina-blue/20 overflow-hidden shadow-soft"
                        >
                          <div
                    ...
                    <span className="text-sm text-voxcina-blue/60 dark:text-secondary-300 bg-secondary-100 dark:bg-voxcina-blue/20 px-3 py-1 rounded-full">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2 space-x-reverse">
                      ...
                      <span className="bg-secondary-100 dark:bg-voxcina-blue/30 text-voxcina-blue dark:text-secondary-200 px-3 py-1 rounded-full text-xs">
                        #{trend.tags[1]}
                      </span>
                    </div>
                    ...
                    >
                      <Link
                        href={`/categories/trending/${trend.id}`}
      ...
      <section className="py-20 bg-secondary-100/50 dark:bg-voxcina-blue/5 relative">
        <div className="absolute inset-0 z-0 overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-voxcina-blue/5 dark:bg-voxcina-blue/10 rounded-full blur-3xl"></div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <motion.span
              className="inline-block py-1.5 px-4 rounded-full bg-voxcina-blue/10 dark:bg-voxcina-blue/20 text-voxcina-blue dark:text-secondary-200 text-sm mb-4 border border-voxcina-blue/20 dark:border-voxcina-blue/30 shadow-soft"
              variants={fadeIn}
            >
              رویدادهای جهانی مد
            </motion.span>
            ...
            <motion.h2
              ...
              variants={fadeIn}
            >
              <span className="relative z-10">هفته‌های مد بین‌المللی</span>
              <span className="absolute bottom-1 left-0 w-full h-3 bg-secondary-200 dark:bg-voxcina-blue/20 rounded-full -z-0 opacity-40"></span>
            </motion.h2>

            <motion.p
              className="text-voxcina-blue/80 dark:text-secondary-300 max-w-2xl mx-auto"
              variants={fadeIn}
            >
          ...
          >
            {FASHION_WEEKS.map((week, index) => (
              <motion.div
                key={index}
                className="relative rounded-2xl overflow-hidden shadow-soft border border-secondary-200 dark:border-voxcina-darkBlue/30 group"
                variants={itemVariant}
                whileHover={{ y: -5 }}
              >
                <div className="aspect-[3/4] relative overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-voxcina-darkBlue/80 via-voxcina-darkBlue/40 to-voxcina-darkBlue/0 flex flex-col justify-end p-6">
                    ...
                    <div className="transform translate-y-8 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                      <motion.a
                        href={week.link}
                        className="inline-block bg-white/20 backdrop-blur-sm text-white border border-white/10 px-4 py-2 rounded-xl hover:bg-white/30 transition-colors shadow-soft"
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.98 }}
                      >
                        مشاهده جزئیات
      ...
      <section className="container mx-auto py-20 px-6 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          >
            <motion.span
              className="inline-block py-1.5 px-4 rounded-full bg-secondary-200/70 dark:bg-voxcina-blue/20 text-voxcina-blue dark:text-secondary-200 text-sm mb-4 border border-secondary-300/30 dark:border-voxcina-blue/30 shadow-soft"
              variants={fadeIn}
            >
              تحلیل ترندها
            </motion.span>
            ...
            <motion.h2
              ...
              variants={fadeIn}
            >
              <span className="relative z-10">تحلیل آماری ترندهای مد ۱۴۰۴</span>
              <span className="absolute bottom-1 left-0 w-full h-3 bg-secondary-200 dark:bg-voxcina-blue/20 rounded-full -z-0 opacity-40"></span>
            </motion.h2>

            <motion.p
              className="text-voxcina-blue/80 dark:text-secondary-300 mb-6"
              variants={fadeIn}
            >
              ...
              {TREND_STATS.map((stat, index) => (
                ...
                >
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-voxcina-blue dark:text-secondary-200 font-bold">
                      {stat.percentage}%
                    </span>
                  </div>
                  <div className="w-full bg-secondary-200/50 dark:bg-voxcina-blue/20 rounded-full h-2.5 shadow-inner-soft overflow-hidden">
                    <motion.div
                      className="h-2.5 rounded-full bg-gradient-to-r from-voxcina-blue to-primary-400"
            ...
            >
              <motion.a
                ...
                className="inline-flex items-center font-medium text-voxcina-blue dark:text-secondary-200 hover:text-voxcina-darkBlue dark:hover:text-white transition-colors"
                variants={fadeIn}
              >
          ...
          <motion.div
            ...
            variants={scaleUp}
          >
            <div className="rounded-2xl overflow-hidden shadow-medium border border-secondary-200 dark:border-voxcina-darkBlue/30 backdrop-blur-sm">
              <div className="aspect-video relative bg-voxcina-blue dark:bg-voxcina-darkBlue p-6 md:p-8 flex flex-col justify-between">
                <div className="absolute inset-0 bg-[url('/pattern.svg')] opacity-5"></div>
                <div className="absolute inset-0 overflow-hidden">
                  <div className="absolute top-0 left-0 w-64 h-64 bg-white/5 rounded-full blur-3xl"></div>
                  <div className="absolute bottom-0 right-0 w-64 h-64 bg-primary-400/10 rounded-full blur-3xl"></div>
                </div>
                ...
                <div className="relative z-10 mt-6 h-48 md:h-64">
                  <div className="absolute inset-x-0 bottom-0 flex items-end justify-around h-full">
                    {[65, 40, 85, 30, 70, 50, 90].map((height, index) => (
                      ...
                      >
                        <div className="rounded-t w-full bg-gradient-to-t from-voxcina-blue to-primary-400 shadow-soft h-full"></div>
                      </motion.div>
                    ))}
                  </div>
                ...
                <div className="relative z-10 text-center">
                  <div className="grid grid-cols-7 mt-2">
                    {[
                      ...
                      <div
                        key={index}
                        className="text-xs text-secondary-100 truncate px-1"
                      >
                        {label}
                      </div>
                    ))}
      ...
      <section className="container mx-auto py-20 px-6 relative">
        <div className="absolute inset-0 z-0 overflow-hidden">
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-voxcina-blue/5 dark:bg-voxcina-blue/10 rounded-full blur-3xl"></div>
        </div>
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          <motion.h2
            ...
            variants={fadeIn}
          >
            <span className="relative z-10">الهام از اینستاگرام</span>
            <span className="absolute bottom-1 left-0 w-full h-3 bg-secondary-200 dark:bg-voxcina-blue/20 rounded-full -z-0 opacity-40"></span>
          </motion.h2>
          <motion.p
            className="text-voxcina-blue/80 dark:text-secondary-300 max-w-2xl mx-auto"
        ...
        >
          {[...Array(12)].map((_, index) => (
            <motion.a
              key={index}
              href="#"
              className="group relative aspect-square overflow-hidden bg-secondary-100 dark:bg-voxcina-blue/10 rounded-xl border border-secondary-200 dark:border-voxcina-darkBlue/30 shadow-soft hover:shadow-medium transition-all duration-300"
              variants={itemVariant}
              whileHover={{ scale: 1.02, y: -5 }}
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-voxcina-darkBlue/0 to-voxcina-darkBlue/0 group-hover:from-voxcina-darkBlue/50 group-hover:to-voxcina-darkBlue/30 transition-all duration-300 z-10"></div>
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20">
                <motion.div
                  className="bg-white/20 backdrop-blur-md p-2 rounded-full shadow-soft border border-white/10"
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                >
                  <svg
        ...
        >
          <motion.a
            ...
            className="inline-flex items-center text-voxcina-blue dark:text-secondary-200 hover:text-voxcina-darkBlue dark:hover:text-white transition-colors"
            whileHover={{ scale: 1.05 }}
          >
            <span className="text-lg mr-2 font-medium">@voxcina</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              fill="none"
        ...
        >
          ...
          >
            ...
            <motion.h3
              ...
              variants={fadeIn}
            >
              <span className="relative z-10">از آخرین ترندها باخبر شوید</span>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-1">
                  <input
                    ...
                    className="w-full px-5 py-4 rounded-xl outline-none text-right pr-10 bg-white/10 backdrop-blur-md border border-white/10 text-white placeholder-white/50 focus:bg-white/15 transition-all duration-300 shadow-soft focus:shadow-medium"
                  />
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <motion.button
                  className="bg-white text-voxcina-blue px-8 py-4 rounded-xl hover:bg-white/90 transition-colors font-medium shadow-soft hover:shadow-medium"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.98 }}
                >
                  عضویت
      ...
      <section className="container mx-auto py-20 px-6 relative">
        ...
        >
          <motion.h2
            ...
            variants={fadeIn}
          >
            <span className="relative z-10">کارشناسان استایل</span>
            <span className="absolute bottom-1 left-0 w-full h-3 bg-secondary-200 dark:bg-voxcina-blue/20 rounded-full -z-0 opacity-40"></span>
          </motion.h2>
          <motion.p
            className="text-voxcina-blue/80 dark:text-secondary-300 max-w-2xl mx-auto"
        ...
        >
          {EXPERTS.map((expert, index) => (
            <motion.div
              key={index}
              className="text-center bg-white/90 dark:bg-voxcina-blue/10 p-6 rounded-2xl shadow-soft hover:shadow-medium transition-all duration-300 border border-secondary-200 dark:border-voxcina-darkBlue/30 backdrop-blur-sm"
              variants={itemVariant}
              whileHover={{ y: -5 }}
            >
              <div className="relative mb-6 mx-auto w-32 h-32 rounded-full overflow-hidden border-4 border-secondary-100 dark:border-voxcina-blue/20 shadow-medium">
                <div
              ...
              <p className="text-primary-500 dark:text-primary-300 mb-4 bg-voxcina-blue/5 dark:bg-voxcina-blue/20 py-1 px-3 rounded-full inline-block text-sm">
                {expert.role}
              </p>
              <p className="text-voxcina-blue/70 dark:text-secondary-300 text-sm mb-5">
                {expert.bio}
              </p>
              ...
              <div className="flex justify-center space-x-3 space-x-reverse">
                <motion.a
                  href="#"
                  className="w-8 h-8 rounded-full bg-secondary-100 dark:bg-voxcina-blue/20 flex items-center justify-center hover:bg-voxcina-blue hover:text-white dark:hover:bg-secondary-200 dark:hover:text-voxcina-blue text-voxcina-blue/70 dark:text-secondary-300 transition-colors"
