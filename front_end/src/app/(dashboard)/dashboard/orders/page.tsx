...
import { Package, Filter, Search, FileText, TruckIcon, Clock, AlertCircle, Calendar, Download } from 'lucide-react';
    ...
    <div className="container py-8 md:py-12">
      ...
      >
        <div className="inline-flex bg-gray-100 dark:bg-gray-800/50 rounded-xl p-1 min-w-full sm:min-w-0">
          ...
          <button 
            className={`px-4 py-2 text-sm rounded-lg transition-all min-w-20 ${
              activeTab === 'shipping' ? 'bg-white dark:bg-gray-700 shadow-sm text-indigo-600 dark:text-indigo-400' : 'text-gray-600 dark:text-gray-400 hover:bg-white/50 dark:hover:bg-gray-700/50'
            }`}
          ...
          <button 
            className={`px-4 py-2 text-sm rounded-lg transition-all min-w-20 ${
              activeTab === 'cancelled' ? 'bg-white dark:bg-gray-700 shadow-sm text-indigo-600 dark:text-indigo-400' : 'text-gray-600 dark:text-gray-400 hover:bg-white/50 dark:hover:bg-gray-700/50'
            }`}
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8 flex items-center justify-center">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">در حال بارگذاری سفارش‌ها...</p>
                </div>
              </CardContent>
            </Card>
          </motion.div>
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 dark:bg-gray-800/50">
                    <tr>
                      ...
                      <th className="text-right p-4 text-gray-600 dark:text-gray-400 font-medium">تعداد</th>
                  ...
                  <tbody>
                    {filteredOrders.map((order, index) => (
                      ...
                      >
                        ...
                        <td className="p-4">
                          <span className={`px-2 py-1 rounded-full text-xs flex items-center inline-flex ${getStatusStyle(order.status)}`}>
      ...
      >
            ...
            <CardContent className="p-4">
              <ul className="space-y-2 text-sm">
                <li className="flex items-start">
                  ...
                  <span><strong className="text-amber-600 dark:text-amber-400">در انتظار پرداخت:</strong> سفارش شما ثبت شده و منتظر پرداخت است.</span>
                </li>
                <li className="flex items-start">
                  <span className="w-3 h-3 rounded-full bg-blue-400 mt-1.5 ml-2 flex-shrink-0"></span>
                  <span><strong className="text-blue-600 dark:text-blue-400">در حال ارسال:</strong> سفارش شما آماده و در مسیر ارسال است.</span>
                </li>
                <li className="flex items-start">
                  <span className="w-3 h-3 rounded-full bg-green-400 mt-1.5 ml-2 flex-shrink-0"></span>
                  <span><strong className="text-green-600 dark:text-green-400">تحویل شده:</strong> سفارش شما با موفقیت تحویل داده شده است.</span>
                </li>
                <li className="flex items-start">
                  <span className="w-3 h-3 rounded-full bg-red-400 mt-1.5 ml-2 flex-shrink-0"></span>
                  <span><strong className="text-red-600 dark:text-red-400">لغو شده:</strong> سفارش شما به دلایلی لغو شده است.</span>
                </li>
              </ul>
            </CardContent>
          </Card>
        ...
        <motion.div variants={itemVariants}>
          <Card className="border border-purple-100 dark:border-purple-900/30 shadow-md hover:shadow-lg transition-shadow overflow-hidden">
            ...
            <CardContent className="p-4">
              <p className="text-sm mb-4">برای پیگیری وضعیت ارسال سفارش خود، می‌توانید از کد رهگیری پستی استفاده نمایید.</p>
              <div className="flex items-center bg-purple-50 dark:bg-purple-900/20 p-3 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-purple-600 dark:text-purple-500 mt-1">کد رهگیری را در قسمت جزئیات سفارش می‌توانید مشاهده کنید</p>
                </div>
              </div>
            </CardContent>
          </Card>
