...
export interface Order {
  ...
  merchant_transaction_id?: string; // Transaction ID generated by this store; the only one the customer sees
  gateway_transaction_id?: string; // Transaction ID returned by the provider; admin only
